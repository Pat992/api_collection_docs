...
4. After importing, open the collection’s **Variables** tab and replace either the `x-rapidapi-key` if using RapidAPi or `X-APIHUB-TOKEN` if using APIHUB with your own credentials.
